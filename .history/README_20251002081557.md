...
1. **Tải Node.js**
   ...
   - Chọn "Windows Installer (.msi)" cho hệ điều hành 64-bit
...
#### Sử dụng Node Version Manager (NVM) - Khuyến nghị
NVM cho phép cài đặt và chuyển đổi giữa nhiều phiên bản Node.js:
...
3. Mở Command Prompt mới và chạy:
   ```bash
   nvm install 18.17.0    # Cài đặt Node.js v18.17.0
   nvm use 18.17.0        # Sử dụng phiên bản này
   ```
